...
class NativeStartDatetimeAttributeTransformer implements AttributeTransformerInterface
{
    /**
    ...
    public function transform(PimAttributeInterface $attribute)
    {
        ...
        yield new CatalogAttribute(
            Attribute::buildNewWith(
                ...
                'Mage\\Catalog\\Model\\Product\\Attribute\\Backend\\Startdate', // backend_model
                null,                                                           // backend_table
                null,                                                           // frontend_model
                'date',                                                         // frontend_input
