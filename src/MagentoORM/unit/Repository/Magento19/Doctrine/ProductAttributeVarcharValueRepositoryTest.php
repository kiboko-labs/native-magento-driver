...
use Kiboko\Component\MagentoORM\Model\V1_9ce\Immutable\ImmutableVarcharAttributeValue;
...
class ProductAttributeVarcharValueRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function truncateTables()
    {
        ...
        $this->getDoctrineConnection()->exec(
            $platform->getTruncateTableSQL('catalog_product_entity_varchar')
        );
    ...
    protected function setUp()
    {
        ...
        $schemaBuilder->ensureCatalogProductAttributeValueTable('varchar', 'string');
        $schemaBuilder->ensureCatalogProductAttributeValueToStoreLinks('varchar');
        $schemaBuilder->ensureCatalogProductAttributeValueToAttributeLinks('varchar');
        $schemaBuilder->ensureCatalogProductAttributeValueToCatalogProductEntityLinks('varchar');
    ...
    public function testFetchingOneByProductAndAttributeFromDefault()
    {
        ...
        $attribute = $this->getAttributeMock(300, 'title');
        ...
        /** @var VarcharAttributeValueInterface $attributeValue */
        $attributeValue = $this->repository->findOneByProductAndAttributeFromDefault($product, $attribute);
        $this->assertInstanceOf(VarcharAttributeValueInterface::class, $attributeValue);
