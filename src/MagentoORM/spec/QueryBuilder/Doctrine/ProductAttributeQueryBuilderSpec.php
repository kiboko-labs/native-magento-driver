...
namespace spec\Kiboko\Component\MagentoORM\QueryBuilder\Doctrine;
...
class ProductAttributeQueryBuilderSpec extends ObjectBehavior
{
    public function it_is_initializable(Connection $connection)
    {
        ...
        $this->shouldHaveType('Kiboko\Component\MagentoORM\QueryBuilder\Doctrine\ProductAttributeQueryBuilder');
    }
}
